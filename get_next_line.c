...
/*   Updated: 2025/12/29 12:42:15 by jfox             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	stash = build_line(fd, stash, &goodread);
	newline = check_line(&stash);
...
// static char *end_of_file(char *newline, char **stash, int goodread)
// {
// 	int	i;
...
// 	stash = build_line(fd, stash, &goodread);
// 	newline = check_line(&stash);
// 	newline = end_of_file(newline, &stash, goodread);
// 		return (newline);
// }
